...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query the database for matching staff credentials (using prepared statements is recommended)
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: staffdashboard.php"); // Redirect to the dashboard
